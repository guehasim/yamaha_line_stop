            ...
            <table class="table table-striped table-bordered" cellpadding="2" cellspacing="0" style="">
                <thead>
                    <tr style="background:#dadade;">
                        ...
                        <th style="padding: 5px; border: 1px solid black;">Det.Kategori</th>
                        <th style="padding: 5px; border: 1px solid black;">Periode</th>
                        <th style="padding: 5px; border: 1px solid black;">Tgl Begin</th>
                        <th style="padding: 5px; border: 1px solid black;">Tgl After</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo $ad->NamaKategori;?></td>
                        <td style="text-align:center;"><?php echo $ad->NamaDetailKategori;?></td>
                        <td style="text-align:center;"><?php echo date('d M y',strtotime($ad->TglNow));?></td>
                        <td style="text-align:center;"><?php echo date('d M y',strtotime($ad->TglBegin));?></td>
                        <td style="text-align:center;"><?php echo date('d M y',strtotime($ad->TglAfter));?></td>
                        <td style="text-align:center;"><?php echo $ad->NikUser;?></td>
                        <td style="text-align:center;"><?php echo $ad->NamaUser;?></td>
                        <td style="text-align:center;"><?php echo $ad->DeptUser;?></td>
                        <td style="text-align:center;"><?php echo $ad->Deskripsi;?></td>
